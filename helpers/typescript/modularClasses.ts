...
namespace Unit {
    ...
    export type DefenseType = "guard" | "evade" | "counter" | "attack";
}

/** A class representing a unit in the game. */
class Unit {
    protected constructor(bum: BattleUnitModel) {
    ...
    resist = new Proxy(this, {
        ...
        set(self, p: Unit.AttackType | Unit.Sin, value) {
            switch (p) {
                case "slash": self.invoke("ovwatkres", "SLASH", (value * 100) | 0); return true;
                case "pierce": self.invoke("ovwatkres", "PENETRATE", (value * 100) | 0); return true;
                case "blunt": self.invoke("ovwatkres", "HIT", (value * 100) | 0); return true;

                case "wrath": self.invoke("ovwsinres", "CRIMSON", (value * 100) | 0); return true;
                case "lust": self.invoke("ovwsinres", "SCARLET", (value * 100) | 0); return true;
                case "sloth": self.invoke("ovwsinres", "AMBER", (value * 100) | 0); return true;
                case "gluttony": self.invoke("ovwsinres", "SHAMROCK", (value * 100) | 0); return true;
                case "gloom": self.invoke("ovwsinres", "AZURE", (value * 100) | 0); return true;
                case "pride": self.invoke("ovwsinres", "INDIGO", (value * 100) | 0); return true;
                case "envy": self.invoke("ovwsinres", "VIOLET", (value * 100) | 0); return true;
            }
            return false;
        }
    }) as unknown as { [K in Unit.AttackType | Unit.Sin]: number };
}
...
class Battle {
    ...
    static getSinsInDashboard(sin: Unit.Sin | "highest" | "lowest", layer: "bottom" | "top" | "upcoming" | "bottom-and-top" | "bottom-top-and-upcoming") {
        const sinMap = {
            wrath: "CRIMSON",
            lust: "SCARLET",
            sloth: "AMBER",
    ...
    private static resourceProxy(getter: (sinIndex: number) => number, setter: (sinIndex: number, value: number) => true) {
        return new Proxy({}, {
            get(t, key: Unit.Sin) {
                switch (key) {
        ...
        }) as { [x in Unit.Sin]: number };
    }
    static egoResources = {
        ally: this.resourceProxy(
            (i) => InvokeModular("getresource", i),
            (i, v) => {
                InvokeModular("resource", i,
                    v - InvokeModular("getresource", i),
                );
                return true;
            }
        ),
        enemy: this.resourceProxy(
            (i) => InvokeModular("getresource", i, "Enemy"),
            (i, v) => {
                InvokeModular("resource", i,
                    v - InvokeModular("getresource", i, "Enemy"),
                    "Enemy"
                );
                return true;
            }
    ...
    static getResonance(sin: Unit.Sin | "highest", perfect?: boolean) {
        return sin === "highest" ?
